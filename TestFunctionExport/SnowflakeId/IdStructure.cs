namespace ExportExcel.SnowflakeId
{
    ...
    public class IdStructure
    {
        ...
        /// </summary>
        /// <param name="generatorIdBits">Number of bits to use for the timestamp-part of Id's.</param>
        /// <param name="sequenceBits">Number of bits to use for the generator-id of Id's.</param>
