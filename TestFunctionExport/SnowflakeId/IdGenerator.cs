...
namespace ExportExcel.SnowflakeId
{
    /// <summary>
    ...
    public class IdGenerator : IIdGenerator<long>
    {
        ...
        /// <summary>
        /// Gets the <see cref="ConsoleApp1.SnowflakeId.IdGeneratorOptions"/>.
        /// </summary>
        ...
        /// based on the current <see cref="ConsoleApp1.SnowflakeId.IdStructure"/> of the generator.
        /// </summary>
        /// <param name="id">The Id to extract information from.</param>
        /// <returns>Returns an <see cref="SnowflakeId.Id" /> that contains information about the 'decoded' Id.</returns>
        /// <remarks>
        /// IMPORTANT: note that this method relies on the <see cref="ConsoleApp1.SnowflakeId.IdStructure"/> and timesource; if the id was
        ...
        /// <summary>
        /// Gets the number of ticks since the <see cref="ConsoleApp1.SnowflakeId.ITimeSource"/>'s epoch.
        /// </summary>
        /// <returns>Returns the number of ticks since the <see cref="ConsoleApp1.SnowflakeId.ITimeSource"/>'s epoch.</returns>
