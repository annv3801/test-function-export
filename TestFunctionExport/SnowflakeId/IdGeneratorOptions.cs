namespace ExportExcel.SnowflakeId
{
    ...
    public class IdGeneratorOptions
    {
        ...
        private static readonly IdStructure _defaultidstructure = SnowflakeId.IdStructure.Default;
        private static readonly ITimeSource _defaulttimesource = new DefaultTimeSource(DefaultEpoch);
        private static readonly SequenceOverflowStrategy _defaultsequenceoverflowstrategy = SnowflakeId.SequenceOverflowStrategy.Throw;
        ...
        /// <summary>
        /// Gets the <see cref="ConsoleApp1.SnowflakeId.ITimeSource"/> to use when generating ID's.
        /// </summary>
